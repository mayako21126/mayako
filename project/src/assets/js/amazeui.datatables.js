...
(function( $, window, document, undefined ) {
	...
	function _fnAjaxParameters( settings )
	{
        ...
        var type;
        if(settings.oInit.Exvalue.type==null||settings.oInit.Exvalue.type==undefined||settings.oInit.Exvalue.type==""){
            type==null;
        }else{
            type=settings.oInit.Exvalue.type;
        }
		...
		var d = {
			...
			exvalue:settings.oInit.Exvalue,
            type:type
		};
    ...
    _api_register( 'exvalue()', function () {

        _fnAjaxUpdate(DataTable.settings[0])
        return DataTable.settings[0].oInit.Exvalue;
    } );
