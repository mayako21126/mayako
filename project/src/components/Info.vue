  ...
  <div  class="page page-current" transition='animated' v-bind:class="class" >
    ...
    <div class="col-xs-12 col-md-12 yg-header">
      <div class="row middle-xs middle-md">
        <div class="col-xs-4">
          <span class="am-icon-map-marker am-icon-arrow-left size3" v-link="{ path: '/setting'}" external></span>
        </div>
        <div class="col-xs-4">
          <span class="devSta size2">功能介绍</span>
        </div>
        <div class="col-xs-4">
    ...
    <div class="col-xs-12 col-md-12 yg-info-content" >
      <div class="row start-xs start-md">
        <div class="col-xs-12 col-md-12 yg-info-div">
          用户协议
          特别提示
...
<script>
  export default {
    data: function () {
      return { class: localStorage.getItem('class'), xx: 222 }
    },
    ready: function () {
      this.xx='333'
    },
